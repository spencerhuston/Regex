...
class Format
{
	...
	public:
		...
		//helper methods
		bool expand_special(std::string & new_expr, const uint8_t c);
		bool matches(const uint8_t left, const uint8_t right);

		inline uint8_t get_precedence(const uint8_t c)
